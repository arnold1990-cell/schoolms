...
export function StudentsPage() {
  ...
  const fillFormFromStudent = (student: Student) => {
    ...
    setForm({
      ...
      medicalConditions: String(student.medicalConditions ?? ''),
      usesTransport: String(student.usesTransport ?? false),
      pickupPoint: String(student.pickupPoint ?? ''),
      routeName: String(student.routeName ?? ''),
    });
  ...
  const submit = async (event: FormEvent) => {
    ...
    const payload = {
      ...
      usesTransport: form.usesTransport === 'true',
    ...
    <div className="page">
      ...
      <div className="card">
        ...
        <form className="form-grid learner-form" onSubmit={submit}>
          ...
          <details className="accordion-card">
            <summary>Contact Info (Optional)</summary>
            <div className="grid two-col-grid">
          ...
          <details className="accordion-card">
            <summary>Health Info (Optional)</summary>
            <div className="grid two-col-grid">
              <label className="full-width">Medical conditions<textarea value={form.medicalConditions} onChange={(e) => setField('medicalConditions', e.target.value)} /></label>
            </div>
          </details>

          <details className="accordion-card">
            <summary>Transport Info (Optional)</summary>
            <div className="grid two-col-grid">
              <label>Uses transport
                <select value={form.usesTransport} onChange={(e) => setField('usesTransport', e.target.value)}>
